...
# Task 3 – Front-End Skill Assessment (Mazer)

## Objective
Customize an existing admin dashboard and bind UI components to external data.

## What Was Done
- Used provided Mazer template
- Extended UI using Bootstrap 5 components
- Integrated JSON-based data source
- Used JavaScript (ES6) for dynamic binding
...
## How to Run
Open using a local server or browser.

This solution strictly follows the task PDF instructions.
